...
<img src='public/Asia-giff.gif' height='100%' width='100%' />

[![PageMuckUp](./public/Asia-giff.gif)](link) ## 🚀 Get Started All commands are run from the root
of the project, from a terminal: | | Command | Action | | :-- | :-------------- |
:------------------------------------------ | | ⚙️ | `npm install` | Installs dependencies | | ⚙️ |
`npm run dev` | Starts local dev server at `localhost:4321` | | ⚙️ | `npm run build` | Build your
production site to `./dist/` | ## 🛠️ Stack - [**Astro**](https://astro.build/) - The web framework
for content-driven websites. - [**Tailwindcss**](https://tailwindcss.com/) - A utility-first CSS
...
Source fonts in neatly bundled NPM packages. ## 👀 Tecnologies used?
